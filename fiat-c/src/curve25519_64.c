...
static FIAT_25519_FIAT_INLINE void fiat_25519_addcarryx_u51(uint64_t* out1, fiat_25519_uint1* out2, fiat_25519_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  uint64_t x2;
  fiat_25519_uint1 x3;
  x1 = ((uint64_t)((fiat_25519_uint1)arg1 + (uint64_t)arg2) + arg3);
  x2 = (x1 & UINT64_C(0x7ffffffffffff));
  x3 = (fiat_25519_uint1)((uint64_t)x1 >> 51);
  *out1 = x2;
  *out2 = x3;
}
...
static FIAT_25519_FIAT_INLINE void fiat_25519_subborrowx_u51(uint64_t* out1, fiat_25519_uint1* out2, fiat_25519_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  fiat_25519_int1 x2;
  uint64_t x3;
  x1 = ((int64_t)((uint64_t)arg2 - (fiat_25519_uint1)arg1) - (int64_t)arg3);
  x2 = (fiat_25519_int1)((int64_t)x1 >> 51);
...
static FIAT_25519_FIAT_INLINE void fiat_25519_cmovznz_u64(uint64_t* out1, fiat_25519_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  x2 = (uint64_t)((fiat_25519_int1)(fiat_25519_int1)((fiat_25519_uint1)0x0 - (fiat_25519_uint1)x1) & (uint64_t)UINT64_C(0xffffffffffffffff));
...
static FIAT_25519_FIAT_INLINE void fiat_25519_carry_mul(fiat_25519_tight_field_element out1, const fiat_25519_loose_field_element arg1, const fiat_25519_loose_field_element arg2) {
  ...
  uint64_t x51;
  uint64_t x52;
  x1 = u128_mul_u64_u64((arg1[4]), ((arg2[4]) * UINT8_C(0x13)));
  x2 = u128_mul_u64_u64((arg1[4]), ((arg2[3]) * UINT8_C(0x13)));
  x3 = u128_mul_u64_u64((arg1[4]), ((arg2[2]) * UINT8_C(0x13)));
  x4 = u128_mul_u64_u64((arg1[4]), ((arg2[1]) * UINT8_C(0x13)));
  x5 = u128_mul_u64_u64((arg1[3]), ((arg2[4]) * UINT8_C(0x13)));
  x6 = u128_mul_u64_u64((arg1[3]), ((arg2[3]) * UINT8_C(0x13)));
  x7 = u128_mul_u64_u64((arg1[3]), ((arg2[2]) * UINT8_C(0x13)));
  x8 = u128_mul_u64_u64((arg1[2]), ((arg2[4]) * UINT8_C(0x13)));
  x9 = u128_mul_u64_u64((arg1[2]), ((arg2[3]) * UINT8_C(0x13)));
  x10 = u128_mul_u64_u64((arg1[1]), ((arg2[4]) * UINT8_C(0x13)));
  x11 = u128_mul_u64_u64((arg1[4]), (arg2[0]));
  x12 = u128_mul_u64_u64((arg1[3]), (arg2[1]));
  x13 = u128_mul_u64_u64((arg1[3]), (arg2[0]));
  x14 = u128_mul_u64_u64((arg1[2]), (arg2[2]));
  x15 = u128_mul_u64_u64((arg1[2]), (arg2[1]));
  x16 = u128_mul_u64_u64((arg1[2]), (arg2[0]));
  x17 = u128_mul_u64_u64((arg1[1]), (arg2[3]));
  x18 = u128_mul_u64_u64((arg1[1]), (arg2[2]));
  x19 = u128_mul_u64_u64((arg1[1]), (arg2[1]));
  x20 = u128_mul_u64_u64((arg1[1]), (arg2[0]));
  x21 = u128_mul_u64_u64((arg1[0]), (arg2[4]));
  x22 = u128_mul_u64_u64((arg1[0]), (arg2[3]));
  x23 = u128_mul_u64_u64((arg1[0]), (arg2[2]));
  x24 = u128_mul_u64_u64((arg1[0]), (arg2[1]));
  x25 = u128_mul_u64_u64((arg1[0]), (arg2[0]));
  x26 = u128_add_u128_u128(x25, u128_add_u128_u128(x10, u128_add_u128_u128(x9, u128_add_u128_u128(x7, x4))));
  x27 = u64_shr_u128(x26, 51);
  x28 = u64_and_u128_u64(x26, UINT64_C(0x7ffffffffffff));
  x29 = u128_add_u128_u128(x21, u128_add_u128_u128(x17, u128_add_u128_u128(x14, u128_add_u128_u128(x12, x11))));
  x30 = u128_add_u128_u128(x22, u128_add_u128_u128(x18, u128_add_u128_u128(x15, u128_add_u128_u128(x13, x1))));
  x31 = u128_add_u128_u128(x23, u128_add_u128_u128(x19, u128_add_u128_u128(x16, u128_add_u128_u128(x5, x2))));
  x32 = u128_add_u128_u128(x24, u128_add_u128_u128(x20, u128_add_u128_u128(x8, u128_add_u128_u128(x6, x3))));
  x33 = u128_add_u64_u128(x27, x32);
  x34 = u64_shr_u128(x33, 51);
  x35 = u64_and_u128_u64(x33, UINT64_C(0x7ffffffffffff));
  x36 = u128_add_u64_u128(x34, x31);
  x37 = u64_shr_u128(x36, 51);
  x38 = u64_and_u128_u64(x36, UINT64_C(0x7ffffffffffff));
  x39 = u128_add_u64_u128(x37, x30);
  x40 = u64_shr_u128(x39, 51);
  x41 = u64_and_u128_u64(x39, UINT64_C(0x7ffffffffffff));
  x42 = u128_add_u64_u128(x40, x29);
  x43 = u64_shr_u128(x42, 51);
  x44 = u64_and_u128_u64(x42, UINT64_C(0x7ffffffffffff));
  x45 = (x43 * UINT8_C(0x13));
  x46 = (x28 + x45);
  x47 = (x46 >> 51);
  x48 = (x46 & UINT64_C(0x7ffffffffffff));
  x49 = (x47 + x35);
  x50 = (fiat_25519_uint1)((uint64_t)x49 >> 51);
  x51 = (x49 & UINT64_C(0x7ffffffffffff));
  x52 = (uint64_t)((fiat_25519_uint1)x50 + (uint64_t)x38);
  out1[0] = x48;
  out1[1] = x51;
  out1[2] = x52;
  out1[3] = x41;
...
static FIAT_25519_FIAT_INLINE void fiat_25519_carry_square(fiat_25519_tight_field_element out1, const fiat_25519_loose_field_element arg1) {
  ...
  x7 = ((arg1[2]) * 0x2);
  x8 = ((arg1[1]) * 0x2);
  x9 = u128_mul_u64_u64((arg1[4]), x1);
  x10 = u128_mul_u64_u64((arg1[3]), x2);
  x11 = u128_mul_u64_u64((arg1[3]), x4);
  x12 = u128_mul_u64_u64((arg1[2]), x2);
  x13 = u128_mul_u64_u64((arg1[2]), x5);
  x14 = u128_mul_u64_u64((arg1[2]), (arg1[2]));
  x15 = u128_mul_u64_u64((arg1[1]), x2);
  x16 = u128_mul_u64_u64((arg1[1]), x6);
  x17 = u128_mul_u64_u64((arg1[1]), x7);
  x18 = u128_mul_u64_u64((arg1[1]), (arg1[1]));
  x19 = u128_mul_u64_u64((arg1[0]), x3);
  x20 = u128_mul_u64_u64((arg1[0]), x6);
  x21 = u128_mul_u64_u64((arg1[0]), x7);
  x22 = u128_mul_u64_u64((arg1[0]), x8);
  x23 = u128_mul_u64_u64((arg1[0]), (arg1[0]));
  x24 = u128_add_u128_u128(x23, u128_add_u128_u128(x15, x13));
  x25 = u64_shr_u128(x24, 51);
  x26 = u64_and_u128_u64(x24, UINT64_C(0x7ffffffffffff));
  x27 = u128_add_u128_u128(x19, u128_add_u128_u128(x16, x14));
  x28 = u128_add_u128_u128(x20, u128_add_u128_u128(x17, x9));
  x29 = u128_add_u128_u128(x21, u128_add_u128_u128(x18, x10));
  x30 = u128_add_u128_u128(x22, u128_add_u128_u128(x12, x11));
  x31 = u128_add_u64_u128(x25, x30);
  x32 = u64_shr_u128(x31, 51);
  x33 = u64_and_u128_u64(x31, UINT64_C(0x7ffffffffffff));
  x34 = u128_add_u64_u128(x32, x29);
  x35 = u64_shr_u128(x34, 51);
  x36 = u64_and_u128_u64(x34, UINT64_C(0x7ffffffffffff));
  x37 = u128_add_u64_u128(x35, x28);
  x38 = u64_shr_u128(x37, 51);
  x39 = u64_and_u128_u64(x37, UINT64_C(0x7ffffffffffff));
  x40 = u128_add_u64_u128(x38, x27);
  x41 = u64_shr_u128(x40, 51);
  x42 = u64_and_u128_u64(x40, UINT64_C(0x7ffffffffffff));
  x43 = (x41 * UINT8_C(0x13));
  x44 = (x26 + x43);
  x45 = (x44 >> 51);
  x46 = (x44 & UINT64_C(0x7ffffffffffff));
  x47 = (x45 + x33);
  x48 = (fiat_25519_uint1)((uint64_t)x47 >> 51);
  x49 = (x47 & UINT64_C(0x7ffffffffffff));
  x50 = (uint64_t)((fiat_25519_uint1)x48 + (uint64_t)x36);
  out1[0] = x46;
  out1[1] = x49;
  out1[2] = x50;
  out1[3] = x39;
...
static FIAT_25519_FIAT_INLINE void fiat_25519_carry(fiat_25519_tight_field_element out1, const fiat_25519_loose_field_element arg1) {
  ...
  x7 = (uint64_t)((fiat_25519_uint1)(fiat_25519_uint1)((uint64_t)x6 >> 51) + (uint64_t)(x2 & UINT64_C(0x7ffffffffffff)));
  x8 = (x6 & UINT64_C(0x7ffffffffffff));
  x9 = (x7 & UINT64_C(0x7ffffffffffff));
  x10 = (uint64_t)((fiat_25519_uint1)(fiat_25519_uint1)((uint64_t)x7 >> 51) + (uint64_t)(x3 & UINT64_C(0x7ffffffffffff)));
...
static FIAT_25519_FIAT_INLINE void fiat_25519_to_bytes(uint8_t out1[32], const fiat_25519_tight_field_element arg1) {
  ...
  x65 = (fiat_25519_uint1)((uint64_t)x63 >> 8);
  x66 = (uint64_t)((uint64_t)x23 + (fiat_25519_uint1)x65);
...
static FIAT_25519_FIAT_INLINE void fiat_25519_carry_scmul_121666(fiat_25519_tight_field_element out1, const fiat_25519_loose_field_element arg1) {
  ...
  uint64_t x26;
  uint64_t x27;
  x1 = u128_mul_u64_u64(UINT32_C(0x1db42), (arg1[4]));
  x2 = u128_mul_u64_u64(UINT32_C(0x1db42), (arg1[3]));
  x3 = u128_mul_u64_u64(UINT32_C(0x1db42), (arg1[2]));
  x4 = u128_mul_u64_u64(UINT32_C(0x1db42), (arg1[1]));
  x5 = u128_mul_u64_u64(UINT32_C(0x1db42), (arg1[0]));
  x6 = u64_shr_u128(x5, 51);
  x7 = u64_and_u128_u64(x5, UINT64_C(0x7ffffffffffff));
  x8 = u128_add_u64_u128(x6, x4);
  x9 = u64_shr_u128(x8, 51);
  x10 = u64_and_u128_u64(x8, UINT64_C(0x7ffffffffffff));
  x11 = u128_add_u64_u128(x9, x3);
  x12 = u64_shr_u128(x11, 51);
  x13 = u64_and_u128_u64(x11, UINT64_C(0x7ffffffffffff));
  x14 = u128_add_u64_u128(x12, x2);
  x15 = u64_shr_u128(x14, 51);
  x16 = u64_and_u128_u64(x14, UINT64_C(0x7ffffffffffff));
  x17 = u128_add_u64_u128(x15, x1);
  x18 = u64_shr_u128(x17, 51);
  x19 = u64_and_u128_u64(x17, UINT64_C(0x7ffffffffffff));
  x20 = (x18 * UINT8_C(0x13));
  x21 = (x7 + x20);
  x22 = (fiat_25519_uint1)((uint64_t)x21 >> 51);
  x23 = (x21 & UINT64_C(0x7ffffffffffff));
  x24 = (uint64_t)((fiat_25519_uint1)x22 + (uint64_t)x10);
  x25 = (fiat_25519_uint1)((uint64_t)x24 >> 51);
  x26 = (x24 & UINT64_C(0x7ffffffffffff));
  x27 = (uint64_t)((fiat_25519_uint1)x25 + (uint64_t)x13);
  out1[0] = x23;
  out1[1] = x26;
  out1[2] = x27;
  out1[3] = x16;
