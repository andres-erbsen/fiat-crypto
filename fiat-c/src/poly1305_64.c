/* Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --inline --static --use-value-barrier poly1305 64 3 '2^130 - 5' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax */
...
static FIAT_POLY1305_FIAT_INLINE void fiat_poly1305_addcarryx_u44(uint64_t* out1, fiat_poly1305_uint1* out2, fiat_poly1305_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  x1 = ((uint64_t)((fiat_poly1305_uint1)arg1 + (uint64_t)arg2) + arg3);
  x2 = (x1 & UINT64_C(0xfffffffffff));
  x3 = (fiat_poly1305_uint1)((uint64_t)x1 >> 44);
  *out1 = x2;
  *out2 = x3;
}
...
static FIAT_POLY1305_FIAT_INLINE void fiat_poly1305_subborrowx_u44(uint64_t* out1, fiat_poly1305_uint1* out2, fiat_poly1305_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  uint64_t x3;
  x1 = ((int64_t)((uint64_t)arg2 - (fiat_poly1305_uint1)arg1) - (int64_t)arg3);
  x2 = (fiat_poly1305_int1)((int64_t)x1 >> 44);
...
static FIAT_POLY1305_FIAT_INLINE void fiat_poly1305_addcarryx_u43(uint64_t* out1, fiat_poly1305_uint1* out2, fiat_poly1305_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  x3 = (fiat_poly1305_uint1)((uint64_t)x1 >> 43);
  *out1 = x2;
  *out2 = x3;
}
...
static FIAT_POLY1305_FIAT_INLINE void fiat_poly1305_subborrowx_u43(uint64_t* out1, fiat_poly1305_uint1* out2, fiat_poly1305_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  uint64_t x3;
  x1 = ((int64_t)((uint64_t)arg2 - (fiat_poly1305_uint1)arg1) - (int64_t)arg3);
  x2 = (fiat_poly1305_int1)((int64_t)x1 >> 43);
...
static FIAT_POLY1305_FIAT_INLINE void fiat_poly1305_cmovznz_u64(uint64_t* out1, fiat_poly1305_uint1 arg1, uint64_t arg2, uint64_t arg3) {
  ...
  x2 = (uint64_t)((fiat_poly1305_int1)(fiat_poly1305_int1)((fiat_poly1305_uint1)0x0 - (fiat_poly1305_uint1)x1) & (uint64_t)UINT64_C(0xffffffffffffffff));
...
static FIAT_POLY1305_FIAT_INLINE void fiat_poly1305_carry_mul(fiat_poly1305_tight_field_element out1, const fiat_poly1305_loose_field_element arg1, const fiat_poly1305_loose_field_element arg2) {
  ...
  uint64_t x27;
  uint64_t x28;
  x1 = u128_mul_u64_u64((arg1[2]), ((arg2[2]) * 0x5));
  x2 = u128_mul_u64_u64((arg1[2]), ((arg2[1]) * 0xa));
  x3 = u128_mul_u64_u64((arg1[1]), ((arg2[2]) * 0xa));
  x4 = u128_mul_u64_u64((arg1[2]), (arg2[0]));
  x5 = u128_mul_u64_u64((arg1[1]), ((arg2[1]) * 0x2));
  x6 = u128_mul_u64_u64((arg1[1]), (arg2[0]));
  x7 = u128_mul_u64_u64((arg1[0]), (arg2[2]));
  x8 = u128_mul_u64_u64((arg1[0]), (arg2[1]));
  x9 = u128_mul_u64_u64((arg1[0]), (arg2[0]));
  x10 = u128_add_u128_u128(x9, u128_add_u128_u128(x3, x2));
  x11 = u64_shr_u128(x10, 44);
  x12 = u64_and_u128_u64(x10, UINT64_C(0xfffffffffff));
  x13 = u128_add_u128_u128(x7, u128_add_u128_u128(x5, x4));
  x14 = u128_add_u128_u128(x8, u128_add_u128_u128(x6, x1));
  x15 = u128_add_u64_u128(x11, x14);
  x16 = u64_shr_u128(x15, 43);
  x17 = u64_and_u128_u64(x15, UINT64_C(0x7ffffffffff));
  x18 = u128_add_u64_u128(x16, x13);
  x19 = u64_shr_u128(x18, 43);
  x20 = u64_and_u128_u64(x18, UINT64_C(0x7ffffffffff));
  x21 = (x19 * 0x5);
  x22 = (x12 + x21);
  x23 = (x22 >> 44);
  x24 = (x22 & UINT64_C(0xfffffffffff));
  x25 = (x23 + x17);
  x26 = (fiat_poly1305_uint1)((uint64_t)x25 >> 43);
  x27 = (x25 & UINT64_C(0x7ffffffffff));
  x28 = (uint64_t)((fiat_poly1305_uint1)x26 + (uint64_t)x20);
  out1[0] = x24;
  out1[1] = x27;
  out1[2] = x28;
}
...
static FIAT_POLY1305_FIAT_INLINE void fiat_poly1305_carry_square(fiat_poly1305_tight_field_element out1, const fiat_poly1305_loose_field_element arg1) {
  ...
  x3 = ((arg1[2]) * 0x2);
  x4 = ((arg1[1]) * 0x2);
  x5 = u128_mul_u64_u64((arg1[2]), x1);
  x6 = u128_mul_u64_u64((arg1[1]), (x2 * 0x2));
  x7 = u128_mul_u64_u64((arg1[1]), ((arg1[1]) * 0x2));
  x8 = u128_mul_u64_u64((arg1[0]), x3);
  x9 = u128_mul_u64_u64((arg1[0]), x4);
  x10 = u128_mul_u64_u64((arg1[0]), (arg1[0]));
  x11 = u128_add_u128_u128(x10, x6);
  x12 = u64_shr_u128(x11, 44);
  x13 = u64_and_u128_u64(x11, UINT64_C(0xfffffffffff));
  x14 = u128_add_u128_u128(x8, x7);
  x15 = u128_add_u128_u128(x9, x5);
  x16 = u128_add_u64_u128(x12, x15);
  x17 = u64_shr_u128(x16, 43);
  x18 = u64_and_u128_u64(x16, UINT64_C(0x7ffffffffff));
  x19 = u128_add_u64_u128(x17, x14);
  x20 = u64_shr_u128(x19, 43);
  x21 = u64_and_u128_u64(x19, UINT64_C(0x7ffffffffff));
  x22 = (x20 * 0x5);
  x23 = (x13 + x22);
  x24 = (x23 >> 44);
  x25 = (x23 & UINT64_C(0xfffffffffff));
  x26 = (x24 + x18);
  x27 = (fiat_poly1305_uint1)((uint64_t)x26 >> 43);
  x28 = (x26 & UINT64_C(0x7ffffffffff));
  x29 = (uint64_t)((fiat_poly1305_uint1)x27 + (uint64_t)x21);
  out1[0] = x25;
  out1[1] = x28;
  out1[2] = x29;
}
...
static FIAT_POLY1305_FIAT_INLINE void fiat_poly1305_carry(fiat_poly1305_tight_field_element out1, const fiat_poly1305_loose_field_element arg1) {
  ...
  x5 = (uint64_t)((fiat_poly1305_uint1)(fiat_poly1305_uint1)((uint64_t)x4 >> 44) + (uint64_t)(x2 & UINT64_C(0x7ffffffffff)));
  x6 = (x4 & UINT64_C(0xfffffffffff));
  x7 = (x5 & UINT64_C(0x7ffffffffff));
  x8 = (uint64_t)((fiat_poly1305_uint1)(fiat_poly1305_uint1)((uint64_t)x5 >> 43) + (uint64_t)(x3 & UINT64_C(0x7ffffffffff)));
  out1[0] = x6;
  out1[1] = x7;
  out1[2] = x8;
}
 ...
 */
static FIAT_POLY1305_FIAT_INLINE void fiat_poly1305_selectznz(uint64_t out1[3], fiat_poly1305_uint1 arg1, const uint64_t arg2[3], const uint64_t arg3[3]) {
  uint64_t x1;
  uint64_t x2;
  uint64_t x3;
...
static FIAT_POLY1305_FIAT_INLINE void fiat_poly1305_from_bytes(fiat_poly1305_tight_field_element out1, const uint8_t arg1[17]) {
  ...
  x31 = (fiat_poly1305_uint1)((uint64_t)x29 >> 43);
  x32 = (uint64_t)((uint64_t)x6 + (fiat_poly1305_uint1)x31);
  x33 = (x5 + x32);
  x34 = (x4 + x33);
  x35 = (x3 + x34);
  x36 = (x2 + x35);
