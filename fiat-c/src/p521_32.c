/* Autogenerated: 'src/ExtractionOCaml/unsaturated_solinas' --inline --static --use-value-barrier p521 32 '(auto)' '2^521 - 1' carry_mul carry_square carry add sub opp selectznz to_bytes from_bytes relax */
...
typedef uint32_t fiat_p521_loose_field_element[19];
...
typedef uint32_t fiat_p521_tight_field_element[19];
 ...
 *   out2: [0x0 ~> 0x1]
 */
static FIAT_P521_FIAT_INLINE void fiat_p521_addcarryx_u28(uint32_t* out1, fiat_p521_uint1* out2, fiat_p521_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  uint32_t x1;
  uint32_t x2;
  fiat_p521_uint1 x3;
 ...
 *   out2: [0x0 ~> 0x1]
 */
static FIAT_P521_FIAT_INLINE void fiat_p521_subborrowx_u28(uint32_t* out1, fiat_p521_uint1* out2, fiat_p521_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  int32_t x1;
  fiat_p521_int1 x2;
  uint32_t x3;
 ...
 *   out2: [0x0 ~> 0x1]
 */
static FIAT_P521_FIAT_INLINE void fiat_p521_addcarryx_u27(uint32_t* out1, fiat_p521_uint1* out2, fiat_p521_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  uint32_t x1;
  uint32_t x2;
  fiat_p521_uint1 x3;
  x1 = ((uint32_t)((fiat_p521_uint1)arg1 + (uint32_t)arg2) + arg3);
 ...
 *   out2: [0x0 ~> 0x1]
 */
static FIAT_P521_FIAT_INLINE void fiat_p521_subborrowx_u27(uint32_t* out1, fiat_p521_uint1* out2, fiat_p521_uint1 arg1, uint32_t arg2, uint32_t arg3) {
  int32_t x1;
  fiat_p521_int1 x2;
  uint32_t x3;
  x1 = ((int32_t)((uint32_t)arg2 - (fiat_p521_uint1)arg1) - (int32_t)arg3);
 ...
 */
static FIAT_P521_FIAT_INLINE void fiat_p521_selectznz(uint32_t out1[19], fiat_p521_uint1 arg1, const uint32_t arg2[19], const uint32_t arg3[19]) {
  uint32_t x1;
  uint32_t x2;
  uint32_t x3;
  uint32_t x4;
