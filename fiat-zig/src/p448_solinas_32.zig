...
pub fn toBytes(out1: *[56]u8, arg1: TightFieldElement) void {
    ...
    subborrowxU32(&x33, &x34, x32, cast(u32, 0x0), cast(u32, 0x0));
    var x35: u32 = undefined;
    var x36: u1 = undefined;
    addcarryxU28(&x35, &x36, 0x0, x1, (x33 & 0xfffffff));
    var x37: u32 = undefined;
    var x38: u1 = undefined;
    addcarryxU28(&x37, &x38, x36, x3, (x33 & 0xfffffff));
    var x39: u32 = undefined;
    var x40: u1 = undefined;
    addcarryxU28(&x39, &x40, x38, x5, (x33 & 0xfffffff));
    var x41: u32 = undefined;
    var x42: u1 = undefined;
    addcarryxU28(&x41, &x42, x40, x7, (x33 & 0xfffffff));
    var x43: u32 = undefined;
    var x44: u1 = undefined;
    addcarryxU28(&x43, &x44, x42, x9, (x33 & 0xfffffff));
    var x45: u32 = undefined;
    var x46: u1 = undefined;
    addcarryxU28(&x45, &x46, x44, x11, (x33 & 0xfffffff));
    var x47: u32 = undefined;
    var x48: u1 = undefined;
    addcarryxU28(&x47, &x48, x46, x13, (x33 & 0xfffffff));
    var x49: u32 = undefined;
    var x50: u1 = undefined;
    addcarryxU28(&x49, &x50, x48, x15, (x33 & 0xfffffff));
    var x51: u32 = undefined;
    var x52: u1 = undefined;
    addcarryxU28(&x51, &x52, x50, x17, (x33 & 0xffffffe));
    var x53: u32 = undefined;
    var x54: u1 = undefined;
    addcarryxU28(&x53, &x54, x52, x19, (x33 & 0xfffffff));
    var x55: u32 = undefined;
    var x56: u1 = undefined;
    addcarryxU28(&x55, &x56, x54, x21, (x33 & 0xfffffff));
    var x57: u32 = undefined;
    var x58: u1 = undefined;
    addcarryxU28(&x57, &x58, x56, x23, (x33 & 0xfffffff));
    var x59: u32 = undefined;
    var x60: u1 = undefined;
    addcarryxU28(&x59, &x60, x58, x25, (x33 & 0xfffffff));
    var x61: u32 = undefined;
    var x62: u1 = undefined;
    addcarryxU28(&x61, &x62, x60, x27, (x33 & 0xfffffff));
    var x63: u32 = undefined;
    var x64: u1 = undefined;
    addcarryxU28(&x63, &x64, x62, x29, (x33 & 0xfffffff));
    var x65: u32 = undefined;
    var x66: u1 = undefined;
    addcarryxU28(&x65, &x66, x64, x31, (x33 & 0xfffffff));
    const x67 = (x65 << 4);
    const x68 = (x61 << 4);
    const x69 = (x57 << 4);
    const x70 = (x53 << 4);
    ...
    const x73 = (x41 << 4);
    const x74 = (x37 << 4);
    const x75 = cast(u8, (x35 & cast(u32, 0xff)));
    const x76 = (x35 >> 8);
    const x77 = cast(u8, (x76 & cast(u32, 0xff)));
    const x78 = (x76 >> 8);
    const x79 = cast(u8, (x78 & cast(u32, 0xff)));
    const x80 = cast(u8, (x78 >> 8));
    const x81 = (x74 + cast(u32, x80));
    const x82 = cast(u8, (x81 & cast(u32, 0xff)));
    const x83 = (x81 >> 8);
    const x84 = cast(u8, (x83 & cast(u32, 0xff)));
    const x85 = (x83 >> 8);
    const x86 = cast(u8, (x85 & cast(u32, 0xff)));
    const x87 = cast(u8, (x85 >> 8));
    const x88 = cast(u8, (x39 & cast(u32, 0xff)));
    const x89 = (x39 >> 8);
    const x90 = cast(u8, (x89 & cast(u32, 0xff)));
    const x91 = (x89 >> 8);
    const x92 = cast(u8, (x91 & cast(u32, 0xff)));
    const x93 = cast(u8, (x91 >> 8));
    const x94 = (x73 + cast(u32, x93));
    ...
    const x140 = cast(u8, (x55 & cast(u32, 0xff)));
    const x141 = (x55 >> 8);
    const x142 = cast(u8, (x141 & cast(u32, 0xff)));
    const x143 = (x141 >> 8);
    const x144 = cast(u8, (x143 & cast(u32, 0xff)));
    const x145 = cast(u8, (x143 >> 8));
    const x146 = (x69 + cast(u32, x145));
    const x147 = cast(u8, (x146 & cast(u32, 0xff)));
    const x148 = (x146 >> 8);
    const x149 = cast(u8, (x148 & cast(u32, 0xff)));
    const x150 = (x148 >> 8);
    const x151 = cast(u8, (x150 & cast(u32, 0xff)));
    const x152 = cast(u8, (x150 >> 8));
    const x153 = cast(u8, (x59 & cast(u32, 0xff)));
    const x154 = (x59 >> 8);
    const x155 = cast(u8, (x154 & cast(u32, 0xff)));
    const x156 = (x154 >> 8);
    const x157 = cast(u8, (x156 & cast(u32, 0xff)));
    const x158 = cast(u8, (x156 >> 8));
    const x159 = (x68 + cast(u32, x158));
    const x160 = cast(u8, (x159 & cast(u32, 0xff)));
    const x161 = (x159 >> 8);
    const x162 = cast(u8, (x161 & cast(u32, 0xff)));
    const x163 = (x161 >> 8);
    const x164 = cast(u8, (x163 & cast(u32, 0xff)));
    const x165 = cast(u8, (x163 >> 8));
    const x166 = cast(u8, (x63 & cast(u32, 0xff)));
    const x167 = (x63 >> 8);
    const x168 = cast(u8, (x167 & cast(u32, 0xff)));
    const x169 = (x167 >> 8);
    const x170 = cast(u8, (x169 & cast(u32, 0xff)));
    const x171 = cast(u8, (x169 >> 8));
    const x172 = (x67 + cast(u32, x171));
    const x173 = cast(u8, (x172 & cast(u32, 0xff)));
    const x174 = (x172 >> 8);
    const x175 = cast(u8, (x174 & cast(u32, 0xff)));
    const x176 = (x174 >> 8);
    const x177 = cast(u8, (x176 & cast(u32, 0xff)));
    const x178 = cast(u8, (x176 >> 8));
    out1[0] = x75;
    out1[1] = x77;
    out1[2] = x79;
    out1[3] = x82;
