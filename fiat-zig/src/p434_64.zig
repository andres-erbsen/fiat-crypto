...
pub fn sub(out1: *MontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement, arg2: MontgomeryDomainFieldElement) void {
    ...
    var x17: u64 = undefined;
    var x18: u1 = undefined;
    addcarryxU64(&x17, &x18, 0x0, x1, x15);
    var x19: u64 = undefined;
    var x20: u1 = undefined;
    addcarryxU64(&x19, &x20, x18, x3, x15);
    var x21: u64 = undefined;
    var x22: u1 = undefined;
    addcarryxU64(&x21, &x22, x20, x5, x15);
    var x23: u64 = undefined;
    var x24: u1 = undefined;
    addcarryxU64(&x23, &x24, x22, x7, (x15 & 0xfdc1767ae2ffffff));
    var x25: u64 = undefined;
    var x26: u1 = undefined;
    addcarryxU64(&x25, &x26, x24, x9, (x15 & 0x7bc65c783158aea3));
    var x27: u64 = undefined;
    var x28: u1 = undefined;
    addcarryxU64(&x27, &x28, x26, x11, (x15 & 0x6cfc5fd681c52056));
    var x29: u64 = undefined;
    var x30: u1 = undefined;
    addcarryxU64(&x29, &x30, x28, x13, (x15 & 0x2341f27177344));
    out1[0] = x17;
    out1[1] = x19;
    out1[2] = x21;
    out1[3] = x23;
...
pub fn divstep(out1: *u64, out2: *[8]u64, out3: *[8]u64, out4: *[7]u64, out5: *[7]u64, arg1: u64, arg2: [8]u64, arg3: [8]u64, arg4: [7]u64, arg5: [7]u64) void {
    ...
    subborrowxU64(&x97, &x98, x96, cast(u64, 0x0), cast(u64, 0x0));
    var x99: u64 = undefined;
    var x100: u1 = undefined;
    addcarryxU64(&x99, &x100, 0x0, x83, x97);
    var x101: u64 = undefined;
    var x102: u1 = undefined;
    addcarryxU64(&x101, &x102, x100, x85, x97);
    var x103: u64 = undefined;
    var x104: u1 = undefined;
    addcarryxU64(&x103, &x104, x102, x87, x97);
    var x105: u64 = undefined;
    var x106: u1 = undefined;
    addcarryxU64(&x105, &x106, x104, x89, (x97 & 0xfdc1767ae2ffffff));
    var x107: u64 = undefined;
    var x108: u1 = undefined;
    addcarryxU64(&x107, &x108, x106, x91, (x97 & 0x7bc65c783158aea3));
    var x109: u64 = undefined;
    var x110: u1 = undefined;
    addcarryxU64(&x109, &x110, x108, x93, (x97 & 0x6cfc5fd681c52056));
    var x111: u64 = undefined;
    var x112: u1 = undefined;
    addcarryxU64(&x111, &x112, x110, x95, (x97 & 0x2341f27177344));
    var x113: u64 = undefined;
    ...
    const x120 = cast(u1, (x31 & cast(u64, 0x1)));
    var x121: u64 = undefined;
    cmovznzU64(&x121, x120, cast(u64, 0x0), x7);
    var x122: u64 = undefined;
    cmovznzU64(&x122, x120, cast(u64, 0x0), x8);
    var x123: u64 = undefined;
    cmovznzU64(&x123, x120, cast(u64, 0x0), x9);
    var x124: u64 = undefined;
    cmovznzU64(&x124, x120, cast(u64, 0x0), x10);
    var x125: u64 = undefined;
    cmovznzU64(&x125, x120, cast(u64, 0x0), x11);
    var x126: u64 = undefined;
    cmovznzU64(&x126, x120, cast(u64, 0x0), x12);
    var x127: u64 = undefined;
    cmovznzU64(&x127, x120, cast(u64, 0x0), x13);
    var x128: u64 = undefined;
    cmovznzU64(&x128, x120, cast(u64, 0x0), x14);
    var x129: u64 = undefined;
    var x130: u1 = undefined;
    addcarryxU64(&x129, &x130, 0x0, x31, x121);
    var x131: u64 = undefined;
    var x132: u1 = undefined;
    addcarryxU64(&x131, &x132, x130, x32, x122);
    var x133: u64 = undefined;
    var x134: u1 = undefined;
    addcarryxU64(&x133, &x134, x132, x33, x123);
    var x135: u64 = undefined;
    var x136: u1 = undefined;
    addcarryxU64(&x135, &x136, x134, x34, x124);
    var x137: u64 = undefined;
    var x138: u1 = undefined;
    addcarryxU64(&x137, &x138, x136, x35, x125);
    var x139: u64 = undefined;
    var x140: u1 = undefined;
    addcarryxU64(&x139, &x140, x138, x36, x126);
    var x141: u64 = undefined;
    var x142: u1 = undefined;
    addcarryxU64(&x141, &x142, x140, x37, x127);
    var x143: u64 = undefined;
    var x144: u1 = undefined;
    addcarryxU64(&x143, &x144, x142, x38, x128);
    var x145: u64 = undefined;
    cmovznzU64(&x145, x120, cast(u64, 0x0), x39);
    var x146: u64 = undefined;
    cmovznzU64(&x146, x120, cast(u64, 0x0), x40);
    var x147: u64 = undefined;
    cmovznzU64(&x147, x120, cast(u64, 0x0), x41);
    var x148: u64 = undefined;
    cmovznzU64(&x148, x120, cast(u64, 0x0), x42);
    var x149: u64 = undefined;
    cmovznzU64(&x149, x120, cast(u64, 0x0), x43);
    var x150: u64 = undefined;
    cmovznzU64(&x150, x120, cast(u64, 0x0), x44);
    var x151: u64 = undefined;
    cmovznzU64(&x151, x120, cast(u64, 0x0), x45);
    var x152: u64 = undefined;
    var x153: u1 = undefined;
    addcarryxU64(&x152, &x153, 0x0, x113, x145);
    var x154: u64 = undefined;
    var x155: u1 = undefined;
    addcarryxU64(&x154, &x155, x153, x114, x146);
    var x156: u64 = undefined;
    var x157: u1 = undefined;
    addcarryxU64(&x156, &x157, x155, x115, x147);
    var x158: u64 = undefined;
    var x159: u1 = undefined;
    addcarryxU64(&x158, &x159, x157, x116, x148);
    var x160: u64 = undefined;
    var x161: u1 = undefined;
    addcarryxU64(&x160, &x161, x159, x117, x149);
    var x162: u64 = undefined;
    var x163: u1 = undefined;
    addcarryxU64(&x162, &x163, x161, x118, x150);
    var x164: u64 = undefined;
    var x165: u1 = undefined;
    addcarryxU64(&x164, &x165, x163, x119, x151);
    var x166: u64 = undefined;
    var x167: u1 = undefined;
    subborrowxU64(&x166, &x167, 0x0, x152, 0xffffffffffffffff);
    var x168: u64 = undefined;
    var x169: u1 = undefined;
    subborrowxU64(&x168, &x169, x167, x154, 0xffffffffffffffff);
    var x170: u64 = undefined;
    var x171: u1 = undefined;
    subborrowxU64(&x170, &x171, x169, x156, 0xffffffffffffffff);
    var x172: u64 = undefined;
    var x173: u1 = undefined;
    subborrowxU64(&x172, &x173, x171, x158, 0xfdc1767ae2ffffff);
    var x174: u64 = undefined;
    var x175: u1 = undefined;
    subborrowxU64(&x174, &x175, x173, x160, 0x7bc65c783158aea3);
    var x176: u64 = undefined;
    var x177: u1 = undefined;
    subborrowxU64(&x176, &x177, x175, x162, 0x6cfc5fd681c52056);
    var x178: u64 = undefined;
    var x179: u1 = undefined;
    subborrowxU64(&x178, &x179, x177, x164, 0x2341f27177344);
    var x180: u64 = undefined;
    var x181: u1 = undefined;
    subborrowxU64(&x180, &x181, x179, cast(u64, x165), cast(u64, 0x0));
    var x182: u64 = undefined;
    var x183: u1 = undefined;
    addcarryxU64(&x182, &x183, 0x0, x6, cast(u64, 0x1));
    const x184 = ((x129 >> 1) | ((x131 << 63) & 0xffffffffffffffff));
    const x185 = ((x131 >> 1) | ((x133 << 63) & 0xffffffffffffffff));
    const x186 = ((x133 >> 1) | ((x135 << 63) & 0xffffffffffffffff));
    const x187 = ((x135 >> 1) | ((x137 << 63) & 0xffffffffffffffff));
    const x188 = ((x137 >> 1) | ((x139 << 63) & 0xffffffffffffffff));
    const x189 = ((x139 >> 1) | ((x141 << 63) & 0xffffffffffffffff));
    const x190 = ((x141 >> 1) | ((x143 << 63) & 0xffffffffffffffff));
    const x191 = ((x143 & 0x8000000000000000) | (x143 >> 1));
    var x192: u64 = undefined;
    cmovznzU64(&x192, x75, x60, x46);
    var x193: u64 = undefined;
    cmovznzU64(&x193, x75, x62, x48);
    var x194: u64 = undefined;
    cmovznzU64(&x194, x75, x64, x50);
    var x195: u64 = undefined;
    cmovznzU64(&x195, x75, x66, x52);
    var x196: u64 = undefined;
    cmovznzU64(&x196, x75, x68, x54);
    var x197: u64 = undefined;
    cmovznzU64(&x197, x75, x70, x56);
    var x198: u64 = undefined;
    cmovznzU64(&x198, x75, x72, x58);
    var x199: u64 = undefined;
    cmovznzU64(&x199, x181, x166, x152);
    var x200: u64 = undefined;
    cmovznzU64(&x200, x181, x168, x154);
    var x201: u64 = undefined;
    cmovznzU64(&x201, x181, x170, x156);
    var x202: u64 = undefined;
    cmovznzU64(&x202, x181, x172, x158);
    var x203: u64 = undefined;
    cmovznzU64(&x203, x181, x174, x160);
    var x204: u64 = undefined;
    cmovznzU64(&x204, x181, x176, x162);
    var x205: u64 = undefined;
    cmovznzU64(&x205, x181, x178, x164);
    out1.* = x182;
    out2[0] = x7;
    out2[1] = x8;
    out2[2] = x9;
