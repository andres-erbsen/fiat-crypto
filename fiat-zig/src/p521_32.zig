...
pub fn toBytes(out1: *[66]u8, arg1: TightFieldElement) void {
    ...
    subborrowxU32(&x39, &x40, x38, cast(u32, 0x0), cast(u32, 0x0));
    ...
    const x79 = (cast(u64, x77) << 6);
    const x80 = (x75 << 3);
    const x81 = (cast(u64, x73) << 7);
    const x82 = (x71 << 4);
    const x83 = (x67 << 5);
    const x84 = (x65 << 2);
    const x85 = (cast(u64, x63) << 6);
    const x86 = (x61 << 3);
    const x87 = (cast(u64, x59) << 7);
    const x88 = (x57 << 4);
    const x89 = (x53 << 5);
    const x90 = (x51 << 2);
    const x91 = (cast(u64, x49) << 6);
    const x92 = (x47 << 3);
    const x93 = (cast(u64, x45) << 7);
    const x94 = (x43 << 4);
    const x95 = cast(u8, (x41 & cast(u32, 0xff)));
    const x96 = (x41 >> 8);
    const x97 = cast(u8, (x96 & cast(u32, 0xff)));
    const x98 = (x96 >> 8);
    const x99 = cast(u8, (x98 & cast(u32, 0xff)));
    const x100 = cast(u8, (x98 >> 8));
    const x101 = (x94 + cast(u32, x100));
    const x102 = cast(u8, (x101 & cast(u32, 0xff)));
    const x103 = (x101 >> 8);
    const x104 = cast(u8, (x103 & cast(u32, 0xff)));
    const x105 = (x103 >> 8);
    const x106 = cast(u8, (x105 & cast(u32, 0xff)));
    const x107 = cast(u8, (x105 >> 8));
    const x108 = (x93 + cast(u64, x107));
    const x109 = cast(u8, (x108 & cast(u64, 0xff)));
    const x110 = cast(u32, (x108 >> 8));
    const x111 = cast(u8, (x110 & cast(u32, 0xff)));
    const x112 = (x110 >> 8);
    const x113 = cast(u8, (x112 & cast(u32, 0xff)));
    const x114 = (x112 >> 8);
    const x115 = cast(u8, (x114 & cast(u32, 0xff)));
    const x116 = cast(u8, (x114 >> 8));
    const x117 = (x92 + cast(u32, x116));
    const x118 = cast(u8, (x117 & cast(u32, 0xff)));
    const x119 = (x117 >> 8);
    const x120 = cast(u8, (x119 & cast(u32, 0xff)));
    const x121 = (x119 >> 8);
    const x122 = cast(u8, (x121 & cast(u32, 0xff)));
    const x123 = cast(u8, (x121 >> 8));
    const x124 = (x91 + cast(u64, x123));
    const x125 = cast(u8, (x124 & cast(u64, 0xff)));
    const x126 = cast(u32, (x124 >> 8));
    const x127 = cast(u8, (x126 & cast(u32, 0xff)));
    const x128 = (x126 >> 8);
    const x129 = cast(u8, (x128 & cast(u32, 0xff)));
    const x130 = (x128 >> 8);
    const x131 = cast(u8, (x130 & cast(u32, 0xff)));
    const x132 = cast(u8, (x130 >> 8));
    const x133 = (x90 + cast(u32, x132));
    const x134 = cast(u8, (x133 & cast(u32, 0xff)));
    const x135 = (x133 >> 8);
    const x136 = cast(u8, (x135 & cast(u32, 0xff)));
    const x137 = (x135 >> 8);
    const x138 = cast(u8, (x137 & cast(u32, 0xff)));
    const x139 = cast(u8, (x137 >> 8));
    const x140 = (x89 + cast(u32, x139));
    const x141 = cast(u8, (x140 & cast(u32, 0xff)));
    const x142 = (x140 >> 8);
    const x143 = cast(u8, (x142 & cast(u32, 0xff)));
    const x144 = (x142 >> 8);
    const x145 = cast(u8, (x144 & cast(u32, 0xff)));
    const x146 = cast(u8, (x144 >> 8));
    const x147 = cast(u8, (x55 & cast(u32, 0xff)));
    const x148 = (x55 >> 8);
    const x149 = cast(u8, (x148 & cast(u32, 0xff)));
    const x150 = (x148 >> 8);
    const x151 = cast(u8, (x150 & cast(u32, 0xff)));
    const x152 = cast(u8, (x150 >> 8));
    const x153 = (x88 + cast(u32, x152));
    const x154 = cast(u8, (x153 & cast(u32, 0xff)));
    const x155 = (x153 >> 8);
    const x156 = cast(u8, (x155 & cast(u32, 0xff)));
    const x157 = (x155 >> 8);
    const x158 = cast(u8, (x157 & cast(u32, 0xff)));
    const x159 = cast(u8, (x157 >> 8));
    const x160 = (x87 + cast(u64, x159));
    const x161 = cast(u8, (x160 & cast(u64, 0xff)));
    const x162 = cast(u32, (x160 >> 8));
    const x163 = cast(u8, (x162 & cast(u32, 0xff)));
    const x164 = (x162 >> 8);
    const x165 = cast(u8, (x164 & cast(u32, 0xff)));
    const x166 = (x164 >> 8);
    const x167 = cast(u8, (x166 & cast(u32, 0xff)));
    const x168 = cast(u8, (x166 >> 8));
    const x169 = (x86 + cast(u32, x168));
    const x170 = cast(u8, (x169 & cast(u32, 0xff)));
    const x171 = (x169 >> 8);
    const x172 = cast(u8, (x171 & cast(u32, 0xff)));
    const x173 = (x171 >> 8);
    const x174 = cast(u8, (x173 & cast(u32, 0xff)));
    const x175 = cast(u8, (x173 >> 8));
    const x176 = (x85 + cast(u64, x175));
    const x177 = cast(u8, (x176 & cast(u64, 0xff)));
    const x178 = cast(u32, (x176 >> 8));
    const x179 = cast(u8, (x178 & cast(u32, 0xff)));
    const x180 = (x178 >> 8);
    const x181 = cast(u8, (x180 & cast(u32, 0xff)));
    const x182 = (x180 >> 8);
    const x183 = cast(u8, (x182 & cast(u32, 0xff)));
    const x184 = cast(u8, (x182 >> 8));
    const x185 = (x84 + cast(u32, x184));
    const x186 = cast(u8, (x185 & cast(u32, 0xff)));
    const x187 = (x185 >> 8);
    const x188 = cast(u8, (x187 & cast(u32, 0xff)));
    const x189 = (x187 >> 8);
    const x190 = cast(u8, (x189 & cast(u32, 0xff)));
    const x191 = cast(u8, (x189 >> 8));
    const x192 = (x83 + cast(u32, x191));
    const x193 = cast(u8, (x192 & cast(u32, 0xff)));
    const x194 = (x192 >> 8);
    const x195 = cast(u8, (x194 & cast(u32, 0xff)));
    const x196 = (x194 >> 8);
    const x197 = cast(u8, (x196 & cast(u32, 0xff)));
    const x198 = cast(u8, (x196 >> 8));
    const x199 = cast(u8, (x69 & cast(u32, 0xff)));
    const x200 = (x69 >> 8);
    const x201 = cast(u8, (x200 & cast(u32, 0xff)));
    const x202 = (x200 >> 8);
    const x203 = cast(u8, (x202 & cast(u32, 0xff)));
    const x204 = cast(u8, (x202 >> 8));
    const x205 = (x82 + cast(u32, x204));
    const x206 = cast(u8, (x205 & cast(u32, 0xff)));
    const x207 = (x205 >> 8);
    const x208 = cast(u8, (x207 & cast(u32, 0xff)));
    const x209 = (x207 >> 8);
    const x210 = cast(u8, (x209 & cast(u32, 0xff)));
    const x211 = cast(u8, (x209 >> 8));
    const x212 = (x81 + cast(u64, x211));
    const x213 = cast(u8, (x212 & cast(u64, 0xff)));
    const x214 = cast(u32, (x212 >> 8));
    const x215 = cast(u8, (x214 & cast(u32, 0xff)));
    const x216 = (x214 >> 8);
    const x217 = cast(u8, (x216 & cast(u32, 0xff)));
    const x218 = (x216 >> 8);
    const x219 = cast(u8, (x218 & cast(u32, 0xff)));
    const x220 = cast(u8, (x218 >> 8));
    const x221 = (x80 + cast(u32, x220));
    const x222 = cast(u8, (x221 & cast(u32, 0xff)));
    const x223 = (x221 >> 8);
    const x224 = cast(u8, (x223 & cast(u32, 0xff)));
    const x225 = (x223 >> 8);
    const x226 = cast(u8, (x225 & cast(u32, 0xff)));
    const x227 = cast(u8, (x225 >> 8));
    const x228 = (x79 + cast(u64, x227));
    const x229 = cast(u8, (x228 & cast(u64, 0xff)));
    const x230 = cast(u32, (x228 >> 8));
    const x231 = cast(u8, (x230 & cast(u32, 0xff)));
    const x232 = (x230 >> 8);
    const x233 = cast(u8, (x232 & cast(u32, 0xff)));
    const x234 = (x232 >> 8);
    const x235 = cast(u8, (x234 & cast(u32, 0xff)));
    const x236 = cast(u1, (x234 >> 8));
    out1[0] = x95;
    out1[1] = x97;
    out1[2] = x99;
    out1[3] = x102;
