...
pub fn sub(out1: *MontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement, arg2: MontgomeryDomainFieldElement) void {
    ...
    var x15: u64 = undefined;
    var x16: u1 = undefined;
    addcarryxU64(&x15, &x16, 0x0, x1, (x13 & 0xecec196accc52973));
    var x17: u64 = undefined;
    var x18: u1 = undefined;
    addcarryxU64(&x17, &x18, x16, x3, (x13 & 0x581a0db248b0a77a));
    var x19: u64 = undefined;
    var x20: u1 = undefined;
    addcarryxU64(&x19, &x20, x18, x5, (x13 & 0xc7634d81f4372ddf));
    var x21: u64 = undefined;
    var x22: u1 = undefined;
    addcarryxU64(&x21, &x22, x20, x7, x13);
    var x23: u64 = undefined;
    var x24: u1 = undefined;
    addcarryxU64(&x23, &x24, x22, x9, x13);
    var x25: u64 = undefined;
    var x26: u1 = undefined;
    addcarryxU64(&x25, &x26, x24, x11, x13);
    out1[0] = x15;
    out1[1] = x17;
    out1[2] = x19;
    out1[3] = x21;
...
pub fn divstep(out1: *u64, out2: *[7]u64, out3: *[7]u64, out4: *[6]u64, out5: *[6]u64, arg1: u64, arg2: [7]u64, arg3: [7]u64, arg4: [6]u64, arg5: [6]u64) void {
    ...
    var x87: u64 = undefined;
    var x88: u1 = undefined;
    addcarryxU64(&x87, &x88, 0x0, x73, (x85 & 0xecec196accc52973));
    var x89: u64 = undefined;
    var x90: u1 = undefined;
    addcarryxU64(&x89, &x90, x88, x75, (x85 & 0x581a0db248b0a77a));
    var x91: u64 = undefined;
    var x92: u1 = undefined;
    addcarryxU64(&x91, &x92, x90, x77, (x85 & 0xc7634d81f4372ddf));
    var x93: u64 = undefined;
    var x94: u1 = undefined;
    addcarryxU64(&x93, &x94, x92, x79, x85);
    var x95: u64 = undefined;
    var x96: u1 = undefined;
    addcarryxU64(&x95, &x96, x94, x81, x85);
    var x97: u64 = undefined;
    var x98: u1 = undefined;
    addcarryxU64(&x97, &x98, x96, x83, x85);
    var x99: u64 = undefined;
    cmovznzU64(&x99, x3, (arg5[0]), x87);
    var x100: u64 = undefined;
    cmovznzU64(&x100, x3, (arg5[1]), x89);
    var x101: u64 = undefined;
    cmovznzU64(&x101, x3, (arg5[2]), x91);
    var x102: u64 = undefined;
    cmovznzU64(&x102, x3, (arg5[3]), x93);
    var x103: u64 = undefined;
    cmovznzU64(&x103, x3, (arg5[4]), x95);
    var x104: u64 = undefined;
    cmovznzU64(&x104, x3, (arg5[5]), x97);
    const x105 = cast(u1, (x28 & cast(u64, 0x1)));
    var x106: u64 = undefined;
    cmovznzU64(&x106, x105, cast(u64, 0x0), x7);
    var x107: u64 = undefined;
    cmovznzU64(&x107, x105, cast(u64, 0x0), x8);
    var x108: u64 = undefined;
    cmovznzU64(&x108, x105, cast(u64, 0x0), x9);
    var x109: u64 = undefined;
    cmovznzU64(&x109, x105, cast(u64, 0x0), x10);
    var x110: u64 = undefined;
    cmovznzU64(&x110, x105, cast(u64, 0x0), x11);
    var x111: u64 = undefined;
    cmovznzU64(&x111, x105, cast(u64, 0x0), x12);
    var x112: u64 = undefined;
    cmovznzU64(&x112, x105, cast(u64, 0x0), x13);
    var x113: u64 = undefined;
    var x114: u1 = undefined;
    addcarryxU64(&x113, &x114, 0x0, x28, x106);
    var x115: u64 = undefined;
    var x116: u1 = undefined;
    addcarryxU64(&x115, &x116, x114, x29, x107);
    var x117: u64 = undefined;
    var x118: u1 = undefined;
    addcarryxU64(&x117, &x118, x116, x30, x108);
    var x119: u64 = undefined;
    var x120: u1 = undefined;
    addcarryxU64(&x119, &x120, x118, x31, x109);
    var x121: u64 = undefined;
    var x122: u1 = undefined;
    addcarryxU64(&x121, &x122, x120, x32, x110);
    var x123: u64 = undefined;
    var x124: u1 = undefined;
    addcarryxU64(&x123, &x124, x122, x33, x111);
    var x125: u64 = undefined;
    var x126: u1 = undefined;
    addcarryxU64(&x125, &x126, x124, x34, x112);
    var x127: u64 = undefined;
    cmovznzU64(&x127, x105, cast(u64, 0x0), x35);
    var x128: u64 = undefined;
    cmovznzU64(&x128, x105, cast(u64, 0x0), x36);
    var x129: u64 = undefined;
    cmovznzU64(&x129, x105, cast(u64, 0x0), x37);
    var x130: u64 = undefined;
    cmovznzU64(&x130, x105, cast(u64, 0x0), x38);
    var x131: u64 = undefined;
    cmovznzU64(&x131, x105, cast(u64, 0x0), x39);
    var x132: u64 = undefined;
    cmovznzU64(&x132, x105, cast(u64, 0x0), x40);
    var x133: u64 = undefined;
    var x134: u1 = undefined;
    addcarryxU64(&x133, &x134, 0x0, x99, x127);
    var x135: u64 = undefined;
    var x136: u1 = undefined;
    addcarryxU64(&x135, &x136, x134, x100, x128);
    var x137: u64 = undefined;
    var x138: u1 = undefined;
    addcarryxU64(&x137, &x138, x136, x101, x129);
    var x139: u64 = undefined;
    var x140: u1 = undefined;
    addcarryxU64(&x139, &x140, x138, x102, x130);
    var x141: u64 = undefined;
    var x142: u1 = undefined;
    addcarryxU64(&x141, &x142, x140, x103, x131);
    var x143: u64 = undefined;
    var x144: u1 = undefined;
    addcarryxU64(&x143, &x144, x142, x104, x132);
    var x145: u64 = undefined;
    var x146: u1 = undefined;
    subborrowxU64(&x145, &x146, 0x0, x133, 0xecec196accc52973);
    var x147: u64 = undefined;
    var x148: u1 = undefined;
    subborrowxU64(&x147, &x148, x146, x135, 0x581a0db248b0a77a);
    var x149: u64 = undefined;
    var x150: u1 = undefined;
    subborrowxU64(&x149, &x150, x148, x137, 0xc7634d81f4372ddf);
    var x151: u64 = undefined;
    var x152: u1 = undefined;
    subborrowxU64(&x151, &x152, x150, x139, 0xffffffffffffffff);
    var x153: u64 = undefined;
    var x154: u1 = undefined;
    subborrowxU64(&x153, &x154, x152, x141, 0xffffffffffffffff);
    var x155: u64 = undefined;
    var x156: u1 = undefined;
    subborrowxU64(&x155, &x156, x154, x143, 0xffffffffffffffff);
    var x157: u64 = undefined;
    var x158: u1 = undefined;
    subborrowxU64(&x157, &x158, x156, cast(u64, x144), cast(u64, 0x0));
    var x159: u64 = undefined;
    var x160: u1 = undefined;
    addcarryxU64(&x159, &x160, 0x0, x6, cast(u64, 0x1));
    const x161 = ((x113 >> 1) | ((x115 << 63) & 0xffffffffffffffff));
    const x162 = ((x115 >> 1) | ((x117 << 63) & 0xffffffffffffffff));
    const x163 = ((x117 >> 1) | ((x119 << 63) & 0xffffffffffffffff));
    const x164 = ((x119 >> 1) | ((x121 << 63) & 0xffffffffffffffff));
    const x165 = ((x121 >> 1) | ((x123 << 63) & 0xffffffffffffffff));
    const x166 = ((x123 >> 1) | ((x125 << 63) & 0xffffffffffffffff));
    const x167 = ((x125 & 0x8000000000000000) | (x125 >> 1));
    var x168: u64 = undefined;
    cmovznzU64(&x168, x66, x53, x41);
    var x169: u64 = undefined;
    cmovznzU64(&x169, x66, x55, x43);
    var x170: u64 = undefined;
    cmovznzU64(&x170, x66, x57, x45);
    var x171: u64 = undefined;
    cmovznzU64(&x171, x66, x59, x47);
    var x172: u64 = undefined;
    cmovznzU64(&x172, x66, x61, x49);
    var x173: u64 = undefined;
    cmovznzU64(&x173, x66, x63, x51);
    var x174: u64 = undefined;
    cmovznzU64(&x174, x158, x145, x133);
    var x175: u64 = undefined;
    cmovznzU64(&x175, x158, x147, x135);
    var x176: u64 = undefined;
    cmovznzU64(&x176, x158, x149, x137);
    var x177: u64 = undefined;
    cmovznzU64(&x177, x158, x151, x139);
    var x178: u64 = undefined;
    cmovznzU64(&x178, x158, x153, x141);
    var x179: u64 = undefined;
    cmovznzU64(&x179, x158, x155, x143);
    out1.* = x159;
    out2[0] = x7;
    out2[1] = x8;
    out2[2] = x9;
