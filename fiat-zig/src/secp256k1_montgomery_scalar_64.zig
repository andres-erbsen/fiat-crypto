// Autogenerated: 'src/ExtractionOCaml/word_by_word_montgomery' --lang Zig --internal-static --public-function-case camelCase --private-function-case camelCase --public-type-case UpperCamelCase --private-type-case UpperCamelCase --no-prefix-fiat --package-name secp256k1_montgomery_scalar '' 64 '2^256 - 432420386565659656852420866394968145599' mul square add sub opp from_montgomery to_montgomery nonzero selectznz to_bytes from_bytes one msat divstep divstep_precomp
...
pub fn sub(out1: *MontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement, arg2: MontgomeryDomainFieldElement) void {
    ...
    var x11: u64 = undefined;
    var x12: u1 = undefined;
    addcarryxU64(&x11, &x12, 0x0, x1, (x9 & 0xbfd25e8cd0364141));
    var x13: u64 = undefined;
    var x14: u1 = undefined;
    addcarryxU64(&x13, &x14, x12, x3, (x9 & 0xbaaedce6af48a03b));
    var x15: u64 = undefined;
    var x16: u1 = undefined;
    addcarryxU64(&x15, &x16, x14, x5, (x9 & 0xfffffffffffffffe));
    var x17: u64 = undefined;
    var x18: u1 = undefined;
    addcarryxU64(&x17, &x18, x16, x7, x9);
    out1[0] = x11;
    out1[1] = x13;
    out1[2] = x15;
    out1[3] = x17;
...
pub fn divstep(out1: *u64, out2: *[5]u64, out3: *[5]u64, out4: *[4]u64, out5: *[4]u64, arg1: u64, arg2: [5]u64, arg3: [5]u64, arg4: [4]u64, arg5: [4]u64) void {
    ...
    var x61: u64 = undefined;
    var x62: u1 = undefined;
    subborrowxU64(&x61, &x62, x60, cast(u64, 0x0), cast(u64, 0x0));
    var x63: u64 = undefined;
    var x64: u1 = undefined;
    addcarryxU64(&x63, &x64, 0x0, x53, (x61 & 0xbfd25e8cd0364141));
    var x65: u64 = undefined;
    var x66: u1 = undefined;
    addcarryxU64(&x65, &x66, x64, x55, (x61 & 0xbaaedce6af48a03b));
    var x67: u64 = undefined;
    var x68: u1 = undefined;
    addcarryxU64(&x67, &x68, x66, x57, (x61 & 0xfffffffffffffffe));
    var x69: u64 = undefined;
    var x70: u1 = undefined;
    addcarryxU64(&x69, &x70, x68, x59, x61);
    var x71: u64 = undefined;
    ...
    const x75 = cast(u1, (x22 & cast(u64, 0x1)));
    var x76: u64 = undefined;
    cmovznzU64(&x76, x75, cast(u64, 0x0), x7);
    var x77: u64 = undefined;
    cmovznzU64(&x77, x75, cast(u64, 0x0), x8);
    var x78: u64 = undefined;
    cmovznzU64(&x78, x75, cast(u64, 0x0), x9);
    var x79: u64 = undefined;
    cmovznzU64(&x79, x75, cast(u64, 0x0), x10);
    var x80: u64 = undefined;
    cmovznzU64(&x80, x75, cast(u64, 0x0), x11);
    var x81: u64 = undefined;
    var x82: u1 = undefined;
    addcarryxU64(&x81, &x82, 0x0, x22, x76);
    var x83: u64 = undefined;
    var x84: u1 = undefined;
    addcarryxU64(&x83, &x84, x82, x23, x77);
    var x85: u64 = undefined;
    var x86: u1 = undefined;
    addcarryxU64(&x85, &x86, x84, x24, x78);
    var x87: u64 = undefined;
    var x88: u1 = undefined;
    addcarryxU64(&x87, &x88, x86, x25, x79);
    var x89: u64 = undefined;
    var x90: u1 = undefined;
    addcarryxU64(&x89, &x90, x88, x26, x80);
    var x91: u64 = undefined;
    cmovznzU64(&x91, x75, cast(u64, 0x0), x27);
    var x92: u64 = undefined;
    cmovznzU64(&x92, x75, cast(u64, 0x0), x28);
    var x93: u64 = undefined;
    cmovznzU64(&x93, x75, cast(u64, 0x0), x29);
    var x94: u64 = undefined;
    cmovznzU64(&x94, x75, cast(u64, 0x0), x30);
    var x95: u64 = undefined;
    var x96: u1 = undefined;
    addcarryxU64(&x95, &x96, 0x0, x71, x91);
    var x97: u64 = undefined;
    var x98: u1 = undefined;
    addcarryxU64(&x97, &x98, x96, x72, x92);
    var x99: u64 = undefined;
    var x100: u1 = undefined;
    addcarryxU64(&x99, &x100, x98, x73, x93);
    var x101: u64 = undefined;
    var x102: u1 = undefined;
    addcarryxU64(&x101, &x102, x100, x74, x94);
    var x103: u64 = undefined;
    var x104: u1 = undefined;
    subborrowxU64(&x103, &x104, 0x0, x95, 0xbfd25e8cd0364141);
    var x105: u64 = undefined;
    var x106: u1 = undefined;
    subborrowxU64(&x105, &x106, x104, x97, 0xbaaedce6af48a03b);
    var x107: u64 = undefined;
    var x108: u1 = undefined;
    subborrowxU64(&x107, &x108, x106, x99, 0xfffffffffffffffe);
    var x109: u64 = undefined;
    var x110: u1 = undefined;
    subborrowxU64(&x109, &x110, x108, x101, 0xffffffffffffffff);
    var x111: u64 = undefined;
    var x112: u1 = undefined;
    subborrowxU64(&x111, &x112, x110, cast(u64, x102), cast(u64, 0x0));
    var x113: u64 = undefined;
    var x114: u1 = undefined;
    addcarryxU64(&x113, &x114, 0x0, x6, cast(u64, 0x1));
    const x115 = ((x81 >> 1) | ((x83 << 63) & 0xffffffffffffffff));
    const x116 = ((x83 >> 1) | ((x85 << 63) & 0xffffffffffffffff));
    const x117 = ((x85 >> 1) | ((x87 << 63) & 0xffffffffffffffff));
    const x118 = ((x87 >> 1) | ((x89 << 63) & 0xffffffffffffffff));
    const x119 = ((x89 & 0x8000000000000000) | (x89 >> 1));
    var x120: u64 = undefined;
    cmovznzU64(&x120, x48, x39, x31);
    var x121: u64 = undefined;
    cmovznzU64(&x121, x48, x41, x33);
    var x122: u64 = undefined;
    cmovznzU64(&x122, x48, x43, x35);
    var x123: u64 = undefined;
    cmovznzU64(&x123, x48, x45, x37);
    var x124: u64 = undefined;
    cmovznzU64(&x124, x112, x103, x95);
    var x125: u64 = undefined;
    cmovznzU64(&x125, x112, x105, x97);
    var x126: u64 = undefined;
    cmovznzU64(&x126, x112, x107, x99);
    var x127: u64 = undefined;
    cmovznzU64(&x127, x112, x109, x101);
    out1.* = x113;
    out2[0] = x7;
    out2[1] = x8;
    out2[2] = x9;
