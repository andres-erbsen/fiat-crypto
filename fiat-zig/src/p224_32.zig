...
pub fn sub(out1: *MontgomeryDomainFieldElement, arg1: MontgomeryDomainFieldElement, arg2: MontgomeryDomainFieldElement) void {
    ...
    var x17: u32 = undefined;
    var x18: u1 = undefined;
    addcarryxU32(&x17, &x18, 0x0, x1, cast(u32, cast(u1, (x15 & cast(u32, 0x1)))));
    var x19: u32 = undefined;
    var x20: u1 = undefined;
    addcarryxU32(&x19, &x20, x18, x3, cast(u32, 0x0));
    var x21: u32 = undefined;
    var x22: u1 = undefined;
    addcarryxU32(&x21, &x22, x20, x5, cast(u32, 0x0));
    var x23: u32 = undefined;
    var x24: u1 = undefined;
    addcarryxU32(&x23, &x24, x22, x7, x15);
    var x25: u32 = undefined;
    var x26: u1 = undefined;
    addcarryxU32(&x25, &x26, x24, x9, x15);
    var x27: u32 = undefined;
    var x28: u1 = undefined;
    addcarryxU32(&x27, &x28, x26, x11, x15);
    var x29: u32 = undefined;
    var x30: u1 = undefined;
    addcarryxU32(&x29, &x30, x28, x13, x15);
    out1[0] = x17;
    out1[1] = x19;
    out1[2] = x21;
    out1[3] = x23;
...
pub fn divstep(out1: *u32, out2: *[8]u32, out3: *[8]u32, out4: *[7]u32, out5: *[7]u32, arg1: u32, arg2: [8]u32, arg3: [8]u32, arg4: [7]u32, arg5: [7]u32) void {
    ...
    var x99: u32 = undefined;
    var x100: u1 = undefined;
    addcarryxU32(&x99, &x100, 0x0, x83, cast(u32, cast(u1, (x97 & cast(u32, 0x1)))));
    var x101: u32 = undefined;
    var x102: u1 = undefined;
    addcarryxU32(&x101, &x102, x100, x85, cast(u32, 0x0));
    var x103: u32 = undefined;
    var x104: u1 = undefined;
    addcarryxU32(&x103, &x104, x102, x87, cast(u32, 0x0));
    var x105: u32 = undefined;
    var x106: u1 = undefined;
    addcarryxU32(&x105, &x106, x104, x89, x97);
    var x107: u32 = undefined;
    var x108: u1 = undefined;
    addcarryxU32(&x107, &x108, x106, x91, x97);
    var x109: u32 = undefined;
    var x110: u1 = undefined;
    addcarryxU32(&x109, &x110, x108, x93, x97);
    var x111: u32 = undefined;
    var x112: u1 = undefined;
    addcarryxU32(&x111, &x112, x110, x95, x97);
    var x113: u32 = undefined;
    cmovznzU32(&x113, x3, (arg5[0]), x99);
    var x114: u32 = undefined;
    cmovznzU32(&x114, x3, (arg5[1]), x101);
    var x115: u32 = undefined;
    cmovznzU32(&x115, x3, (arg5[2]), x103);
    var x116: u32 = undefined;
    cmovznzU32(&x116, x3, (arg5[3]), x105);
    var x117: u32 = undefined;
    cmovznzU32(&x117, x3, (arg5[4]), x107);
    var x118: u32 = undefined;
    cmovznzU32(&x118, x3, (arg5[5]), x109);
    var x119: u32 = undefined;
    cmovznzU32(&x119, x3, (arg5[6]), x111);
    const x120 = cast(u1, (x31 & cast(u32, 0x1)));
    var x121: u32 = undefined;
    cmovznzU32(&x121, x120, cast(u32, 0x0), x7);
    var x122: u32 = undefined;
    cmovznzU32(&x122, x120, cast(u32, 0x0), x8);
    var x123: u32 = undefined;
    cmovznzU32(&x123, x120, cast(u32, 0x0), x9);
    var x124: u32 = undefined;
    cmovznzU32(&x124, x120, cast(u32, 0x0), x10);
    var x125: u32 = undefined;
    cmovznzU32(&x125, x120, cast(u32, 0x0), x11);
    var x126: u32 = undefined;
    cmovznzU32(&x126, x120, cast(u32, 0x0), x12);
    var x127: u32 = undefined;
    cmovznzU32(&x127, x120, cast(u32, 0x0), x13);
    var x128: u32 = undefined;
    cmovznzU32(&x128, x120, cast(u32, 0x0), x14);
    var x129: u32 = undefined;
    var x130: u1 = undefined;
    addcarryxU32(&x129, &x130, 0x0, x31, x121);
    var x131: u32 = undefined;
    var x132: u1 = undefined;
    addcarryxU32(&x131, &x132, x130, x32, x122);
    var x133: u32 = undefined;
    var x134: u1 = undefined;
    addcarryxU32(&x133, &x134, x132, x33, x123);
    var x135: u32 = undefined;
    var x136: u1 = undefined;
    addcarryxU32(&x135, &x136, x134, x34, x124);
    var x137: u32 = undefined;
    var x138: u1 = undefined;
    addcarryxU32(&x137, &x138, x136, x35, x125);
    var x139: u32 = undefined;
    var x140: u1 = undefined;
    addcarryxU32(&x139, &x140, x138, x36, x126);
    var x141: u32 = undefined;
    var x142: u1 = undefined;
    addcarryxU32(&x141, &x142, x140, x37, x127);
    var x143: u32 = undefined;
    var x144: u1 = undefined;
    addcarryxU32(&x143, &x144, x142, x38, x128);
    var x145: u32 = undefined;
    cmovznzU32(&x145, x120, cast(u32, 0x0), x39);
    var x146: u32 = undefined;
    cmovznzU32(&x146, x120, cast(u32, 0x0), x40);
    var x147: u32 = undefined;
    cmovznzU32(&x147, x120, cast(u32, 0x0), x41);
    var x148: u32 = undefined;
    cmovznzU32(&x148, x120, cast(u32, 0x0), x42);
    var x149: u32 = undefined;
    cmovznzU32(&x149, x120, cast(u32, 0x0), x43);
    var x150: u32 = undefined;
    cmovznzU32(&x150, x120, cast(u32, 0x0), x44);
    var x151: u32 = undefined;
    cmovznzU32(&x151, x120, cast(u32, 0x0), x45);
    var x152: u32 = undefined;
    var x153: u1 = undefined;
    addcarryxU32(&x152, &x153, 0x0, x113, x145);
    var x154: u32 = undefined;
    var x155: u1 = undefined;
    addcarryxU32(&x154, &x155, x153, x114, x146);
    var x156: u32 = undefined;
    var x157: u1 = undefined;
    addcarryxU32(&x156, &x157, x155, x115, x147);
    var x158: u32 = undefined;
    var x159: u1 = undefined;
    addcarryxU32(&x158, &x159, x157, x116, x148);
    var x160: u32 = undefined;
    var x161: u1 = undefined;
    addcarryxU32(&x160, &x161, x159, x117, x149);
    var x162: u32 = undefined;
    var x163: u1 = undefined;
    addcarryxU32(&x162, &x163, x161, x118, x150);
    var x164: u32 = undefined;
    var x165: u1 = undefined;
    addcarryxU32(&x164, &x165, x163, x119, x151);
    var x166: u32 = undefined;
    var x167: u1 = undefined;
    subborrowxU32(&x166, &x167, 0x0, x152, cast(u32, 0x1));
    var x168: u32 = undefined;
    var x169: u1 = undefined;
    subborrowxU32(&x168, &x169, x167, x154, cast(u32, 0x0));
    var x170: u32 = undefined;
    var x171: u1 = undefined;
    subborrowxU32(&x170, &x171, x169, x156, cast(u32, 0x0));
    var x172: u32 = undefined;
    var x173: u1 = undefined;
    subborrowxU32(&x172, &x173, x171, x158, 0xffffffff);
    var x174: u32 = undefined;
    var x175: u1 = undefined;
    subborrowxU32(&x174, &x175, x173, x160, 0xffffffff);
    var x176: u32 = undefined;
    var x177: u1 = undefined;
    subborrowxU32(&x176, &x177, x175, x162, 0xffffffff);
    var x178: u32 = undefined;
    var x179: u1 = undefined;
    subborrowxU32(&x178, &x179, x177, x164, 0xffffffff);
    var x180: u32 = undefined;
    var x181: u1 = undefined;
    subborrowxU32(&x180, &x181, x179, cast(u32, x165), cast(u32, 0x0));
    var x182: u32 = undefined;
    var x183: u1 = undefined;
    addcarryxU32(&x182, &x183, 0x0, x6, cast(u32, 0x1));
    const x184 = ((x129 >> 1) | ((x131 << 31) & 0xffffffff));
    const x185 = ((x131 >> 1) | ((x133 << 31) & 0xffffffff));
    const x186 = ((x133 >> 1) | ((x135 << 31) & 0xffffffff));
    const x187 = ((x135 >> 1) | ((x137 << 31) & 0xffffffff));
    const x188 = ((x137 >> 1) | ((x139 << 31) & 0xffffffff));
    const x189 = ((x139 >> 1) | ((x141 << 31) & 0xffffffff));
    const x190 = ((x141 >> 1) | ((x143 << 31) & 0xffffffff));
    const x191 = ((x143 & 0x80000000) | (x143 >> 1));
    var x192: u32 = undefined;
    cmovznzU32(&x192, x75, x60, x46);
    var x193: u32 = undefined;
    cmovznzU32(&x193, x75, x62, x48);
    var x194: u32 = undefined;
    cmovznzU32(&x194, x75, x64, x50);
    var x195: u32 = undefined;
    cmovznzU32(&x195, x75, x66, x52);
    var x196: u32 = undefined;
    cmovznzU32(&x196, x75, x68, x54);
    var x197: u32 = undefined;
    cmovznzU32(&x197, x75, x70, x56);
    var x198: u32 = undefined;
    cmovznzU32(&x198, x75, x72, x58);
    var x199: u32 = undefined;
    cmovznzU32(&x199, x181, x166, x152);
    var x200: u32 = undefined;
    cmovznzU32(&x200, x181, x168, x154);
    var x201: u32 = undefined;
    cmovznzU32(&x201, x181, x170, x156);
    var x202: u32 = undefined;
    cmovznzU32(&x202, x181, x172, x158);
    var x203: u32 = undefined;
    cmovznzU32(&x203, x181, x174, x160);
    var x204: u32 = undefined;
    cmovznzU32(&x204, x181, x176, x162);
    var x205: u32 = undefined;
    cmovznzU32(&x205, x181, x178, x164);
    out1.* = x182;
    out2[0] = x7;
    out2[1] = x8;
    out2[2] = x9;
